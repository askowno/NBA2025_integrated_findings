...
![Figure 1. Key pressures on biodiversity in each realm, informed by Red List of Threatened Species and Red List of Ecosystems assessments. The size of the bubbles indicates the relative importance of each pressure class.](images/Fig_4-01.png){width="12cm"}
...
![](images/Fig%206%20map.png){width="12cm"}

![Figure 3. Ecological condition map (terrestrial and marine). The legend shows the categories used across the different realms. Present Ecological State (PES) for freshwater and estuarine, severity of disruption of ecosystem function (IUCN Red List of Ecosystems) and NBA ecological condition categories.](images/clipboard-184907390.png){width="10cm"}
